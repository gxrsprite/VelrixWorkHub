...
- 不是把 OA、CRM、ERP、PMP 和许可证页面堆到同一个菜单，而是让模块独立演进的同时，共享关键主数据引用、权限边界、流程运行时和可追溯的业务状态。
...
| 项目交付记录关联项目、需求和 WBS，并保留状态追溯 | ![项目交付追溯](screenshots/pmp-delivery-traceability.png) |
| 项目需求的优先级、基线、计划日期与项目上下文维护 | ![项目需求管理](screenshots/pmp-requirement-management.png) |
...
- PMP 项目以 CRM 客户为上下文，汇总关联合同、订单、发货、回款和应收，不直接复制 ERP 交易表。
