...
public sealed class PmpProjectErpReportServiceTests
{
    [Fact]
    public void Build_ReportsProjectCommercialTotalsAndExcludesEmptyProjects()
    {
        ...
        var project = new PmpProject("PRJ-REPORT-001", "交付项目", customer, "项目经理", new DateOnly(2026, 1, 1), new DateOnly(2026, 12, 31));
        var emptyProject = new PmpProject("PRJ-REPORT-002", "空项目", otherCustomer, "项目经理", new DateOnly(2026, 1, 1), new DateOnly(2026, 12, 31));
        ...
        var result = PmpProjectErpReportService.Build([project, emptyProject], [order], [settlement], [contract]);
