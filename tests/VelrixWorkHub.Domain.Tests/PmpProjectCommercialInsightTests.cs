...
public sealed class PmpProjectCommercialInsightTests
{
    [Fact]
    public void Build_UsesProjectOrdersAndTheirSettlementsOnly()
    {
        ...
        var project = new PmpProject("PRJ-COMMERCIAL-01", "项目一", customer.Id, null, today, today.AddDays(30));
        var otherProject = new PmpProject("PRJ-COMMERCIAL-02", "项目二", customer.Id, null, today, today.AddDays(30));
        ...
        var result = PmpProjectCommercialInsightService.Build(project, [projectOrder, otherOrder], [projectReceipt, otherReceipt], [contract]);
        ...
        var details = PmpProjectCommercialInsightService.Orders(project, [projectOrder, otherOrder], [projectReceipt, otherReceipt]);
    ...
    public void Build_RecomputesAfterCancellationAndVoidedReceipt()
    {
        ...
        var project = new PmpProject("PRJ-COMMERCIAL-RECALC", "履约重算项目", customer.Id, null, today, today.AddDays(30));
        ...
        var result = PmpProjectCommercialInsightService.Build(project, [shippedOrder, cancelledOrder], [activeReceipt, voidedReceipt], []);
