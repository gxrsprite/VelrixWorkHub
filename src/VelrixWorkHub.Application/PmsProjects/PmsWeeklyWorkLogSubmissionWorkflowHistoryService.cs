...
public sealed class PmsWeeklyWorkLogSubmissionWorkflowHistoryService(WorkflowOperationService operations)
{
    public WorkflowOperation? GetLatestDecision(PmsWeeklyWorkLogSubmission item)
        => operations.List(businessType: nameof(PmsWeeklyWorkLogSubmission), businessId: item.Id)
