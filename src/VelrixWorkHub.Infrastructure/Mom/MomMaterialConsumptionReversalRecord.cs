...
[Table(Name = "MomMaterialConsumptionReversal")]
[Index("MomMaterialConsumptionReversal_uk_SourceNo", "SourceNo", true)]
public sealed class MomMaterialConsumptionReversalRecord
{
    [Column(IsPrimary = true, Position = 1)] public Guid Id { get; set; }
    [Column(Position = 2, IsNullable = false)] public Guid ConsumptionId { get; set; }
    [Column(Position = 3, IsNullable = true)] public Guid? DeliveryId { get; set; }
