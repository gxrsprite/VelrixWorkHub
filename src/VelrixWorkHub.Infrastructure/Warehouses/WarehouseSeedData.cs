...
public static class WarehouseSeedData
{
    ...
    {
        fsql.CodeFirst.SyncStructure<WarehouseRecord>(); fsql.CodeFirst.SyncStructure<WarehouseLocationRecord>(); fsql.CodeFirst.SyncStructure<WarehouseLocationProductCapacityRecord>(); if (fsql.Select<WarehouseRecord>().Any()) return;
