...
public static class WorkflowSeedData
{
    public static void Initialize(IFreeSql fsql)
    {
        ...
        Ensure(repository, WorkflowBindingCodes.PmsWorkItemCompletionApproval, "项目工作项验收审批", "项目工作项完成前的验收审批");
        Ensure(repository, WorkflowBindingCodes.PmsWeeklyWorkLogApproval, "项目周工时审批", "项目成员按周提交工时后的审批");
    ...
    private static void Ensure(FreeSqlWorkflowDefinitionRepository repository, string code, string name, string description)
    {
        ...
        var approvalConfig = code switch
        {
            ...
            WorkflowBindingCodes.PmsWorkItemCompletionApproval => "{\"approver\":\"admin\",\"onApproved\":{\"type\":\"SetField\",\"field\":\"Status\",\"value\":\"Completed\"},\"onRejected\":{\"type\":\"SetField\",\"field\":\"Status\",\"value\":\"InProgress\"},\"onCancelled\":{\"type\":\"SetField\",\"field\":\"Status\",\"value\":\"InProgress\"}}",
            WorkflowBindingCodes.PmsWeeklyWorkLogApproval => "{\"approver\":\"admin\",\"onApproved\":{\"type\":\"SetField\",\"field\":\"Status\",\"value\":\"Approved\"},\"onRejected\":{\"type\":\"SetField\",\"field\":\"Status\",\"value\":\"Rejected\"},\"onCancelled\":{\"type\":\"SetField\",\"field\":\"Status\",\"value\":\"Withdrawn\"}}",
