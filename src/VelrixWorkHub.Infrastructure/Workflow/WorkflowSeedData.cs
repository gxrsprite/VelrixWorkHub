...
public static class WorkflowSeedData
{
    public static void Initialize(IFreeSql fsql)
    {
        ...
        Ensure(repository, WorkflowBindingCodes.PmpWeeklyWorkLogApproval, "项目周工时审批", "项目成员按周提交工时后的审批");
    ...
    private static void Ensure(FreeSqlWorkflowDefinitionRepository repository, string code, string name, string description)
    {
        ...
        var approvalConfig = code switch
        {
            ...
            WorkflowBindingCodes.PmpWeeklyWorkLogApproval => "{\"approver\":\"admin\",\"onApproved\":{\"type\":\"SetField\",\"field\":\"Status\",\"value\":\"Approved\"},\"onRejected\":{\"type\":\"SetField\",\"field\":\"Status\",\"value\":\"Rejected\"},\"onCancelled\":{\"type\":\"SetField\",\"field\":\"Status\",\"value\":\"Withdrawn\"}}",
