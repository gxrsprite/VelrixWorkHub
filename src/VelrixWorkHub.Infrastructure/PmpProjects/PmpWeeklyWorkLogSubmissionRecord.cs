...
[Table(Name = "PmpWeeklyWorkLogSubmission")]
public sealed class PmpWeeklyWorkLogSubmissionRecord
{
    ...
    [Column(MapType = typeof(string), StringLength = 50, IsNullable = false, Position = 7)] public PmpWeeklyWorkLogSubmissionStatus Status { get; set; }
