...
[Table(Name = "PmpDeliveryRecord")]
public sealed class PmpDeliveryRecordRecord
{
    ...
    [Column(MapType = typeof(string), StringLength = 50, IsNullable = false, Position = 6)] public PmpDeliveryRecordType Type { get; set; }
    ...
    [Column(MapType = typeof(string), StringLength = 50, IsNullable = false, Position = 10)] public PmpDeliveryRecordStatus Status { get; set; }
...
[Table(Name = "PmpDeliveryRecordStatusHistory")]
public sealed class PmpDeliveryRecordStatusHistoryRecord
{
    [Column(IsPrimary = true, Position = 1)] public Guid Id { get; set; }
    [Column(IsNullable = false, Position = 2)] public Guid DeliveryRecordId { get; set; }
    [Column(MapType = typeof(string), StringLength = 50, IsNullable = false, Position = 3)] public PmpDeliveryRecordStatus Status { get; set; }
