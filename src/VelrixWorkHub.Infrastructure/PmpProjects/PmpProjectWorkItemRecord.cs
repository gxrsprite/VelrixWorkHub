...
[Table(Name = "PmpProjectWorkItem")]
public sealed class PmpProjectWorkItemRecord
{
    ...
    [Column(MapType = typeof(string), StringLength = 50, IsNullable = false, Position = 12)] public PmpProjectWorkItemPriority Priority { get; set; }
    [Column(MapType = typeof(string), StringLength = 50, IsNullable = false, Position = 13)] public PmpProjectWorkItemStatus Status { get; set; }
