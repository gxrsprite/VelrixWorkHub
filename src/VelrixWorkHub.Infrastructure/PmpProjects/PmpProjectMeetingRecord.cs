...
[Table(Name = "PmpProjectMeeting")]
public sealed class PmpProjectMeetingRecord
{
    ...
    [Column(MapType = typeof(string), StringLength = 50, IsNullable = false, Position = 4)] public PmpProjectMeetingType MeetingType { get; set; }
