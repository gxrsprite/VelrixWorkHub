...
[Table(Name = "PmpRequirement")]
public sealed class PmpRequirementRecord
{
    ...
    [Column(MapType = typeof(string), StringLength = 50, Position = 9)] public PmpRequirementPriority Priority { get; set; }
    [Column(MapType = typeof(string), StringLength = 50, Position = 10)] public PmpRequirementStatus Status { get; set; }
    [Column(MapType = typeof(string), StringLength = 50, Position = 11)] public PmpRequirementType RequirementType { get; set; }
