...
[Table(Name = "PmsProjectChange")]
public sealed class PmsProjectChangeRecord
{
    ...
    [Column(MapType = typeof(string), StringLength = 50, Position = 7, IsNullable = false)] public PmsProjectChangeStatus Status { get; set; }
