...
[Table(Name = "PmsProject")]
public sealed class PmsProjectRecord
{
    ...
    [Column(MapType = typeof(string), StringLength = 50, Position = 9)] public PmsProjectStatus Status { get; set; }
    [Column(MapType = typeof(string), StringLength = 50, IsNullable = true, Position = 10)] public PmsProjectInitiationMode? InitiationMode { get; set; }
