...
[Table(Name = "PmsWbsTask")]
public sealed class PmsWbsTaskRecord
{
    ...
    [Column(MapType = typeof(string), StringLength = 50, Position = 11)] public PmsWbsTaskStatus Status { get; set; }
