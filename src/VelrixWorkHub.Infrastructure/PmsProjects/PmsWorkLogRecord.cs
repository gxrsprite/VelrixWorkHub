...
[Table(Name = "PmsWorkLog")]
public sealed class PmsWorkLogRecord
{
    ...
    [Column(MapType = typeof(string), StringLength = 50, IsNullable = true, Position = 8)] public PmsWorkLogAttendanceStatus? AttendanceStatus { get; set; }
}
