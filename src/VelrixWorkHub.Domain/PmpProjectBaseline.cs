...
public sealed class PmpProjectBaseline
{
    ...
    public PmpProjectBaseline(Guid projectId, int versionNumber, string label, DateTime snapshotTime, DateOnly plannedStart, DateOnly plannedEnd, int percentComplete, int phaseCount, int taskCount)
    {
