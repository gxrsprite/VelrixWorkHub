...
public sealed class PmsProjectMember
{
    ...
    public PmsProjectMember(Guid projectId, string memberName, string roleName, bool isPrimary = false, string? departmentName = null, Guid? userId = null)
