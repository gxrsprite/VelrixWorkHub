...
public sealed class PmpProjectCalendarOverride
{
    ...
    public PmpProjectCalendarOverride(Guid projectId, DateOnly date, bool isWorkingDay, string? note = null) => Edit(projectId, date, isWorkingDay, note);
