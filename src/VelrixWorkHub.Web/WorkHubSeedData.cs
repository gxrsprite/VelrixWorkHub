...
using VelrixWorkHub.Infrastructure.Mom;
...
internal static class WorkHubSeedData
{
    public static void Initialize(FreeSqlCloud<string> fsql)
    {
        ...
        var momRoot = EnsureRootMenu(fsql, "MOM 制造运营", "fa fa-industry", 35);
        var momMasterDataMenu = EnsureChildMenu(fsql, momRoot, "制造基础主数据", "Mom/MasterData", 340);
        EnsureButtonMenu(fsql, momMasterDataMenu, "新建工厂", "Mom/MasterData/Factory/Create", 341);
        EnsureButtonMenu(fsql, momMasterDataMenu, "新建工作中心", "Mom/MasterData/WorkCenter/Create", 342);
        EnsureButtonMenu(fsql, momMasterDataMenu, "启停制造主数据", "Mom/MasterData/Status", 343);
        var workOrderMenu = EnsureChildMenu(fsql, momRoot, "生产工单", "Mom/WorkOrder", 350);
        EnsureButtonMenu(fsql, workOrderMenu, "新建生产工单", "Mom/WorkOrder/Create", 351);
        EnsureButtonMenu(fsql, workOrderMenu, "推进生产工单", "Mom/WorkOrder/Status", 352);
        EnsureButtonMenu(fsql, workOrderMenu, "登记工单完工", "Mom/WorkOrder/Complete", 353);
        EnsureButtonMenu(fsql, workOrderMenu, "完工入库", "Mom/WorkOrder/FinishedGoodsReceipt", 354);
        var shipmentMenu = EnsureChildMenu(fsql, momRoot, "完工交付", "Mom/Shipment", 470);
        EnsureButtonMenu(fsql, shipmentMenu, "销售订单发运", "Mom/Shipment/Create", 471);
        var acceptanceMenu = EnsureChildMenu(fsql, momRoot, "FAT/SAT 验收", "Mom/Acceptance", 475);
        EnsureButtonMenu(fsql, acceptanceMenu, "新建验收单", "Mom/Acceptance/Create", 476);
        EnsureButtonMenu(fsql, acceptanceMenu, "维护验收检查项", "Mom/Acceptance/Item", 477);
        EnsureButtonMenu(fsql, acceptanceMenu, "提交验收单", "Mom/Acceptance/Submit", 478);
        EnsureButtonMenu(fsql, acceptanceMenu, "完成验收", "Mom/Acceptance/Complete", 479);
        EnsureButtonMenu(fsql, acceptanceMenu, "取消验收单", "Mom/Acceptance/Cancel", 480);
        var serviceEquipmentMenu = EnsureChildMenu(fsql, momRoot, "售后设备档案", "Mom/ServiceEquipment", 485);
        EnsureButtonMenu(fsql, serviceEquipmentMenu, "登记售后设备", "Mom/ServiceEquipment/Create", 486);
        EnsureButtonMenu(fsql, serviceEquipmentMenu, "登记安装", "Mom/ServiceEquipment/Install", 487);
        EnsureButtonMenu(fsql, serviceEquipmentMenu, "设备报废", "Mom/ServiceEquipment/Retire", 488);
        EnsureButtonMenu(fsql, serviceEquipmentMenu, "打印设备标签", "Mom/ServiceEquipment/PrintLabel", 489);
        var serviceWorkOrderMenu = EnsureChildMenu(fsql, momRoot, "售后服务工单", "Mom/ServiceWorkOrder", 490);
        EnsureButtonMenu(fsql, serviceWorkOrderMenu, "创建安装工单", "Mom/ServiceWorkOrder/Create", 491);
        EnsureButtonMenu(fsql, serviceWorkOrderMenu, "开始安装工单", "Mom/ServiceWorkOrder/Start", 492);
        EnsureButtonMenu(fsql, serviceWorkOrderMenu, "完成安装工单", "Mom/ServiceWorkOrder/Complete", 493);
        EnsureButtonMenu(fsql, serviceWorkOrderMenu, "取消安装工单", "Mom/ServiceWorkOrder/Cancel", 494);
        EnsureButtonMenu(fsql, serviceWorkOrderMenu, "创建维修工单", "Mom/ServiceWorkOrder/CreateRepair", 495);
        EnsureButtonMenu(fsql, serviceWorkOrderMenu, "登记维修备件", "Mom/ServiceWorkOrder/ConsumeParts", 496);
        var momManufacturingVersionMenu = EnsureChildMenu(fsql, momRoot, "制造版本与 BOM", "Mom/ManufacturingVersion", 360);
        EnsureButtonMenu(fsql, momManufacturingVersionMenu, "新建制造版本", "Mom/ManufacturingVersion/Create", 361);
        EnsureButtonMenu(fsql, momManufacturingVersionMenu, "维护 BOM 组件", "Mom/ManufacturingVersion/Components", 362);
        EnsureButtonMenu(fsql, momManufacturingVersionMenu, "发布制造版本", "Mom/ManufacturingVersion/Release", 363);
        var momOperationStandardMenu = EnsureChildMenu(fsql, momRoot, "工序路线与标准工时", "Mom/OperationStandard", 365);
        EnsureButtonMenu(fsql, momOperationStandardMenu, "维护工序标准", "Mom/OperationStandard/Manage", 366);
        var momPlanningMenu = EnsureChildMenu(fsql, momRoot, "计划与 MRP", "Mom/Mrp", 370);
        EnsureButtonMenu(fsql, momPlanningMenu, "模拟 MRP", "Mom/Mrp/Simulate", 371);
        EnsureButtonMenu(fsql, momPlanningMenu, "确认 MRP 批次", "Mom/Mrp/Confirm", 372);
        var momKittingMenu = EnsureChildMenu(fsql, momRoot, "物料齐套与领料", "Mom/Kitting", 380);
        EnsureButtonMenu(fsql, momKittingMenu, "检查齐套", "Mom/Kitting/Check", 381);
        EnsureButtonMenu(fsql, momKittingMenu, "工单领料", "Mom/Kitting/Issue", 382);
        EnsureButtonMenu(fsql, momKittingMenu, "工单退料", "Mom/Kitting/Return", 383);
        var momOperationsMenu = EnsureChildMenu(fsql, momRoot, "工序执行与报工", "Mom/Operations", 390);
        EnsureButtonMenu(fsql, momOperationsMenu, "生成工序", "Mom/Operations/Ensure", 391);
        EnsureButtonMenu(fsql, momOperationsMenu, "受理工序", "Mom/Operations/Accept", 392);
        EnsureButtonMenu(fsql, momOperationsMenu, "开始工序", "Mom/Operations/Start", 393);
        EnsureButtonMenu(fsql, momOperationsMenu, "暂停工序", "Mom/Operations/Pause", 394);
        EnsureButtonMenu(fsql, momOperationsMenu, "恢复工序", "Mom/Operations/Resume", 395);
        EnsureButtonMenu(fsql, momOperationsMenu, "工序报工", "Mom/Operations/Report", 396);
        EnsureButtonMenu(fsql, momOperationsMenu, "工序完工", "Mom/Operations/Complete", 397);
        EnsureButtonMenu(fsql, momOperationsMenu, "报工更正", "Mom/Operations/CorrectReport", 398);
        EnsureButtonMenu(fsql, momOperationsMenu, "登记工时", "Mom/Operations/WorkLog", 399);
        var momQualityMenu = EnsureChildMenu(fsql, momRoot, "质量检验", "Mom/Quality", 450);
        EnsureButtonMenu(fsql, momQualityMenu, "新建质量检验", "Mom/Quality/Create", 451);
        EnsureButtonMenu(fsql, momQualityMenu, "登记检验结果", "Mom/Quality/Result", 452);
        EnsureButtonMenu(fsql, momQualityMenu, "取消质量检验", "Mom/Quality/Cancel", 453);
        EnsureButtonMenu(fsql, momQualityMenu, "维护质量标准", "Mom/Quality/Standard", 454);
        EnsureButtonMenu(fsql, momQualityMenu, "维护检验项目", "Mom/Quality/StandardItem", 455);
        EnsureButtonMenu(fsql, momQualityMenu, "登记不合格", "Mom/Quality/Nonconformance", 456);
        EnsureButtonMenu(fsql, momQualityMenu, "维护不合格处置", "Mom/Quality/Disposition", 457);
        EnsureButtonMenu(fsql, momQualityMenu, "维护质量报告", "Mom/Quality/Report", 458);
        EnsureButtonMenu(fsql, momQualityMenu, "上传质量报告附件", "Mom/Quality/ReportAttachment", 459);
        EnsureButtonMenu(fsql, momQualityMenu, "关联收货质量检验", "Mom/Quality/ReceiptLink", 460);
        EnsureButtonMenu(fsql, momKittingMenu, "工位配送", "Mom/Kitting/Deliver", 384);
        EnsureButtonMenu(fsql, momKittingMenu, "实际消耗", "Mom/Kitting/Consume", 385);
        EnsureButtonMenu(fsql, momKittingMenu, "物理配送到线边", "Mom/Kitting/PhysicalDeliver", 386);
        EnsureButtonMenu(fsql, momKittingMenu, "撤回配送", "Mom/Kitting/WithdrawDelivery", 387);
        EnsureButtonMenu(fsql, momKittingMenu, "逆向实际消耗", "Mom/Kitting/ReverseConsumption", 388);
        var pmsRoot = EnsureRootMenu(fsql, "项目管理", "fa fa-briefcase", 40);
        EnsureChildMenu(fsql, pmsRoot, "项目组合概览", "Pms/Overview", 400);
        var projectMenu = EnsureChildMenu(fsql, pmsRoot, "项目主数据", "Pms/Project", 401);
        EnsureButtonMenu(fsql, projectMenu, "新建/编辑项目", "Pms/Project/Edit", 410);
        EnsureButtonMenu(fsql, projectMenu, "变更项目状态", "Pms/Project/Status", 411);
        EnsureChildMenu(fsql, pmsRoot, "阶段与里程碑", "Pms/Phase", 402);
        EnsureChildMenu(fsql, pmsRoot, "项目工作日历", "Pms/Calendar", 414);
        EnsureChildMenu(fsql, pmsRoot, "WBS 任务树", "Pms/Wbs", 403);
        EnsureChildMenu(fsql, pmsRoot, "项目成员与角色", "Pms/Member", 404);
        EnsureChildMenu(fsql, pmsRoot, "风险与问题", "Pms/Issue", 405);
        var workItemMenu = EnsureChildMenu(fsql, pmsRoot, "项目工作项", "Pms/WorkItem", 412);
        EnsureButtonMenu(fsql, workItemMenu, "新建工作项", "Pms/WorkItem/Create", 421);
        EnsureButtonMenu(fsql, workItemMenu, "编辑工作项", "Pms/WorkItem/Edit", 422);
        EnsureButtonMenu(fsql, workItemMenu, "推进工作项", "Pms/WorkItem/Status", 423);
        EnsureButtonMenu(fsql, workItemMenu, "添加工作项批注", "Pms/WorkItem/Comment", 424);
        EnsureButtonMenu(fsql, workItemMenu, "提交工作项验收", "Pms/WorkItem/Submit", 425);
        EnsureButtonMenu(fsql, workItemMenu, "撤回工作项验收", "Pms/WorkItem/Withdraw", 426);
        var meetingMenu = EnsureChildMenu(fsql, pmsRoot, "项目会议", "Pms/Meeting", 413);
        EnsureButtonMenu(fsql, meetingMenu, "新建会议", "Pms/Meeting/Create", 431);
        EnsureButtonMenu(fsql, meetingMenu, "编辑会议", "Pms/Meeting/Edit", 432);
        EnsureButtonMenu(fsql, meetingMenu, "创建会议行动项", "Pms/Meeting/ActionItem", 433);
        var deliveryMenu = EnsureChildMenu(fsql, pmsRoot, "交付追溯", "Pms/Delivery", 414);
        EnsureButtonMenu(fsql, deliveryMenu, "新建交付记录", "Pms/Delivery/Create", 441);
        EnsureButtonMenu(fsql, deliveryMenu, "编辑交付记录", "Pms/Delivery/Edit", 442);
        EnsureButtonMenu(fsql, deliveryMenu, "推进交付状态", "Pms/Delivery/Status", 443);
        EnsureChildMenu(fsql, pmsRoot, "需求管理", "Pms/Requirement", 410);
        EnsureChildMenu(fsql, pmsRoot, "团队资源分配", "Pms/Resource", 411);
        EnsureChildMenu(fsql, pmsRoot, "项目基线", "Pms/Baseline", 406);
        EnsureChildMenu(fsql, pmsRoot, "项目变更", "Pms/Change", 407);
        var workLogMenu = EnsureChildMenu(fsql, pmsRoot, "项目工时", "Pms/WorkLog", 408);
        EnsureButtonMenu(fsql, workLogMenu, "提交周工时审批", "Pms/WorkLog/Submit", 481);
        EnsureButtonMenu(fsql, workLogMenu, "撤回周工时审批", "Pms/WorkLog/Withdraw", 482);
        EnsureChildMenu(fsql, pmsRoot, "项目 EVM", "Pms/Evm", 409);
        ...
        PmsProjectSeedData.Initialize(fsql.Use("main"));
        PmsProjectPhaseSeedData.Initialize(fsql.Use("main"));
        PmsWbsTaskSeedData.Initialize(fsql.Use("main"));
        PmsProjectMemberSeedData.Initialize(fsql.Use("main"));
        PmsProjectIssueSeedData.Initialize(fsql.Use("main"));
        PmsRequirementSeedData.Initialize(fsql.Use("main"));
        PmsProjectBaselineSeedData.Initialize(fsql.Use("main"));
        PmsProjectChangeSeedData.Initialize(fsql.Use("main"));
        PmsWorkLogSeedData.Initialize(fsql.Use("main"));
        PurchaseOrderSeedData.Initialize(fsql.Use("main"));
        fsql.CodeFirst.SyncStructure<MomFactoryRecord>();
        fsql.CodeFirst.SyncStructure<MomWorkCenterRecord>();
        fsql.CodeFirst.SyncStructure<MomEquipmentRecord>();
        fsql.CodeFirst.SyncStructure<MomManufacturingVersionRecord>();
        fsql.CodeFirst.SyncStructure<MomManufacturingComponentRecord>();
        fsql.CodeFirst.SyncStructure<MomManufacturingOperationStandardRecord>();
        fsql.CodeFirst.SyncStructure<MomMaterialPlanningRunRecord>();
        fsql.CodeFirst.SyncStructure<MomMaterialPlanningLineRecord>();
        fsql.CodeFirst.SyncStructure<MomWorkOrderMaterialRequirementRecord>();
        fsql.CodeFirst.SyncStructure<MomMaterialMovementRecord>();
        fsql.CodeFirst.SyncStructure<MomMaterialDeliveryRecord>();
        fsql.CodeFirst.SyncStructure<MomMaterialConsumptionRecord>();
        fsql.CodeFirst.SyncStructure<MomMaterialDeliveryReversalRecord>();
        fsql.CodeFirst.SyncStructure<MomMaterialConsumptionAllocationRecord>();
        fsql.CodeFirst.SyncStructure<MomMaterialConsumptionReversalRecord>();
        fsql.CodeFirst.SyncStructure<MomWorkOrderOperationRecord>();
        fsql.CodeFirst.SyncStructure<MomWorkOrderOperationReportRecord>();
        fsql.CodeFirst.SyncStructure<MomWorkOrderOperationReportCorrectionRecord>();
        fsql.CodeFirst.SyncStructure<MomWorkOrderOperationWorkLogRecord>();
        fsql.CodeFirst.SyncStructure<MomQualityInspectionStandardRecord>();
        fsql.CodeFirst.SyncStructure<MomQualityInspectionStandardItemRecord>();
        fsql.CodeFirst.SyncStructure<MomQualityInspectionRecord>();
        fsql.CodeFirst.SyncStructure<MomQualityNonconformanceRecord>();
        fsql.CodeFirst.SyncStructure<MomQualityDispositionRecord>();
        fsql.CodeFirst.SyncStructure<MomQualityReceiptInspectionRecord>();
        fsql.CodeFirst.SyncStructure<MomQualityReportRecord>();
        fsql.CodeFirst.SyncStructure<MomFinishedGoodsReceiptRecord>();
        fsql.CodeFirst.SyncStructure<MomFinishedGoodsShipmentRecord>();
        fsql.CodeFirst.SyncStructure<MomFinishedGoodsShipmentAllocationRecord>();
        fsql.CodeFirst.SyncStructure<MomAcceptanceRecord>();
        fsql.CodeFirst.SyncStructure<MomAcceptanceChecklistItemRecord>();
        fsql.CodeFirst.SyncStructure<MomServiceEquipmentRecord>();
        fsql.CodeFirst.SyncStructure<MomServiceEquipmentLifecycleEntryRecord>();
        fsql.CodeFirst.SyncStructure<MomServiceWorkOrderRecord>();
        fsql.CodeFirst.SyncStructure<MomServiceWorkOrderHistoryRecord>();
        fsql.CodeFirst.SyncStructure<MomServiceWorkOrderPartConsumptionRecord>();
        MomMasterDataSeedData.Initialize(fsql.Use("main"));
        fsql.CodeFirst.SyncStructure<MomWorkOrderRecord>();
        MomWorkOrderSeedData.Initialize(fsql.Use("main"));
        ...
        fsql.CodeFirst.SyncStructure<PmsProjectWorkItemRecord>();
        fsql.CodeFirst.SyncStructure<PmsWeeklyWorkLogSubmissionRecord>();
        fsql.CodeFirst.SyncStructure<PmsProjectWorkItemActivityRecord>();
        fsql.CodeFirst.SyncStructure<PmsProjectMeetingRecord>();
        fsql.CodeFirst.SyncStructure<PmsDeliveryRecordRecord>();
        fsql.CodeFirst.SyncStructure<PmsDeliveryRecordStatusHistoryRecord>();
        ...
        PmsWeeklyWorkLogSubmissionSchemaMigration.EnsureActiveWeekUniqueness(fsql.Use("main"));
