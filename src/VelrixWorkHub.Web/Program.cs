...
builder.Services.AddScoped<IPmsProjectRepository, FreeSqlPmsProjectRepository>();
builder.Services.AddScoped<IPmsProjectStatusHistoryRepository, FreeSqlPmsProjectStatusHistoryRepository>();
builder.Services.AddScoped<PmsProjectService>();
builder.Services.AddScoped<IPmsProjectPhaseRepository, FreeSqlPmsProjectPhaseRepository>();
builder.Services.AddScoped<PmsProjectPhaseService>();
builder.Services.AddScoped<IPmsProjectCalendarOverrideRepository, FreeSqlPmsProjectCalendarOverrideRepository>();
builder.Services.AddScoped<PmsProjectCalendarService>();
builder.Services.AddScoped<IPmsWbsTaskRepository, FreeSqlPmsWbsTaskRepository>();
builder.Services.AddScoped<PmsWbsTaskService>();
builder.Services.AddScoped<IPmsProjectMemberRepository, FreeSqlPmsProjectMemberRepository>();
builder.Services.AddScoped<PmsProjectMemberService>();
builder.Services.AddScoped<IPmsProjectIssueRepository, FreeSqlPmsProjectIssueRepository>();
builder.Services.AddScoped<PmsProjectIssueService>();
builder.Services.AddScoped<IPmsProjectWorkItemRepository, FreeSqlPmsProjectWorkItemRepository>();
builder.Services.AddScoped<IPmsProjectWorkItemActivityRepository, FreeSqlPmsProjectWorkItemActivityRepository>();
builder.Services.AddScoped<PmsProjectWorkItemService>();
builder.Services.AddScoped<IPmsProjectWorkItemWorkflowApprover>(sp => sp.GetRequiredService<PmsProjectWorkItemService>());
builder.Services.AddScoped<PmsProjectWorkItemReminderService>();
builder.Services.AddHostedService<PmsProjectWorkItemReminderWorker>();
builder.Services.AddHostedService<VehicleComplianceReminderWorker>();
builder.Services.AddScoped<IPmsProjectMeetingRepository, FreeSqlPmsProjectMeetingRepository>();
builder.Services.AddScoped<PmsProjectMeetingService>();
builder.Services.AddScoped<IPmsDeliveryRecordRepository, FreeSqlPmsDeliveryRecordRepository>();
builder.Services.AddScoped<IPmsDeliveryRecordStatusHistoryRepository, FreeSqlPmsDeliveryRecordStatusHistoryRepository>();
builder.Services.AddScoped<PmsDeliveryRecordService>();
builder.Services.AddScoped<IPmsRequirementRepository, FreeSqlPmsRequirementRepository>();
builder.Services.AddScoped<PmsRequirementService>();
builder.Services.AddScoped<IPmsProjectBaselineRepository, FreeSqlPmsProjectBaselineRepository>();
builder.Services.AddScoped<PmsProjectBaselineService>();
builder.Services.AddScoped<IPmsProjectChangeRepository, FreeSqlPmsProjectChangeRepository>();
builder.Services.AddScoped<PmsProjectChangeService>();
builder.Services.AddScoped<IPmsProjectChangeWorkflowApprover>(sp => sp.GetRequiredService<PmsProjectChangeService>());
...
builder.Services.AddScoped<IPmsWorkLogRepository, FreeSqlPmsWorkLogRepository>();
builder.Services.AddScoped<PmsWorkLogService>();
builder.Services.AddScoped<IPmsWeeklyWorkLogSubmissionRepository, FreeSqlPmsWeeklyWorkLogSubmissionRepository>();
builder.Services.AddScoped<PmsWeeklyWorkLogSubmissionService>();
builder.Services.AddScoped<PmsWeeklyWorkLogSubmissionWorkflowHistoryService>();
builder.Services.AddScoped<PmsWeeklyWorkLogOutcomeNotificationService>();
builder.Services.AddScoped<IPmsWeeklyWorkLogSubmissionWorkflowApprover>(sp => sp.GetRequiredService<PmsWeeklyWorkLogSubmissionService>());
builder.Services.AddScoped<PmsEvmService>();
...
builder.Services.AddScoped<IMomWorkOrderRepository, FreeSqlMomWorkOrderRepository>();
builder.Services.AddScoped<MomWorkOrderService>();
builder.Services.AddScoped<IMomFactoryRepository, FreeSqlMomFactoryRepository>();
builder.Services.AddScoped<MomFactoryService>();
builder.Services.AddScoped<IMomWorkCenterRepository, FreeSqlMomWorkCenterRepository>();
builder.Services.AddScoped<MomWorkCenterService>();
builder.Services.AddScoped<IMomEquipmentRepository, FreeSqlMomEquipmentRepository>();
builder.Services.AddScoped<MomEquipmentService>();
builder.Services.AddScoped<IMomEquipmentResolver>(sp => sp.GetRequiredService<MomEquipmentService>());
builder.Services.AddScoped<IMomManufacturingVersionRepository, FreeSqlMomManufacturingVersionRepository>();
builder.Services.AddScoped<IMomManufacturingComponentRepository, FreeSqlMomManufacturingComponentRepository>();
builder.Services.AddScoped<IMomManufacturingOperationStandardRepository, FreeSqlMomManufacturingOperationStandardRepository>();
builder.Services.AddScoped<MomManufacturingVersionService>();
builder.Services.AddScoped<MomManufacturingOperationStandardService>();
builder.Services.AddScoped<IMomMaterialPlanningRunRepository, FreeSqlMomMaterialPlanningRunRepository>();
builder.Services.AddScoped<IMomMaterialPlanningLineRepository, FreeSqlMomMaterialPlanningLineRepository>();
builder.Services.AddScoped<MomMaterialPlanningService>();
builder.Services.AddScoped<IMomWorkOrderMaterialRequirementRepository, FreeSqlMomWorkOrderMaterialRequirementRepository>();
builder.Services.AddScoped<IMomMaterialMovementRepository, FreeSqlMomMaterialMovementRepository>();
builder.Services.AddScoped<IMomMaterialDeliveryRepository, FreeSqlMomMaterialDeliveryRepository>();
builder.Services.AddScoped<IMomMaterialConsumptionRepository, FreeSqlMomMaterialConsumptionRepository>();
builder.Services.AddScoped<IMomMaterialDeliveryReversalRepository, FreeSqlMomMaterialDeliveryReversalRepository>();
builder.Services.AddScoped<IMomMaterialConsumptionAllocationRepository, FreeSqlMomMaterialConsumptionAllocationRepository>();
builder.Services.AddScoped<IMomMaterialConsumptionReversalRepository, FreeSqlMomMaterialConsumptionReversalRepository>();
builder.Services.AddScoped<MomMaterialKittingService>();
builder.Services.AddScoped<IMomWorkOrderOperationRepository, FreeSqlMomWorkOrderOperationRepository>();
builder.Services.AddScoped<IMomWorkOrderOperationReportRepository, FreeSqlMomWorkOrderOperationReportRepository>();
builder.Services.AddScoped<IMomWorkOrderOperationReportCorrectionRepository, FreeSqlMomWorkOrderOperationReportCorrectionRepository>();
builder.Services.AddScoped<IMomWorkOrderOperationWorkLogRepository, FreeSqlMomWorkOrderOperationWorkLogRepository>();
builder.Services.AddScoped<IMomQualityInspectionRepository, FreeSqlMomQualityInspectionRepository>();
builder.Services.AddScoped<IMomQualityInspectionStandardRepository, FreeSqlMomQualityInspectionStandardRepository>();
builder.Services.AddScoped<IMomQualityInspectionStandardItemRepository, FreeSqlMomQualityInspectionStandardItemRepository>();
builder.Services.AddScoped<MomQualityInspectionStandardService>();
builder.Services.AddScoped<IMomQualityNonconformanceRepository, FreeSqlMomQualityNonconformanceRepository>();
builder.Services.AddScoped<IMomQualityDispositionRepository, FreeSqlMomQualityDispositionRepository>();
builder.Services.AddScoped<MomQualityNonconformanceService>();
builder.Services.AddScoped<IMomQualityReceiptInspectionRepository, FreeSqlMomQualityReceiptInspectionRepository>();
builder.Services.AddScoped<MomQualityReceiptInspectionService>();
builder.Services.AddScoped<IMomFinishedGoodsReceiptRepository, FreeSqlMomFinishedGoodsReceiptRepository>();
builder.Services.AddScoped<MomFinishedGoodsReceiptService>();
builder.Services.AddScoped<IMomFinishedGoodsShipmentRepository, FreeSqlMomFinishedGoodsShipmentRepository>();
builder.Services.AddScoped<IMomFinishedGoodsShipmentAllocationRepository, FreeSqlMomFinishedGoodsShipmentAllocationRepository>();
builder.Services.AddScoped<MomFinishedGoodsShipmentService>();
builder.Services.AddScoped<IMomAcceptanceRepository, FreeSqlMomAcceptanceRepository>();
builder.Services.AddScoped<IMomAcceptanceChecklistRepository, FreeSqlMomAcceptanceChecklistRepository>();
builder.Services.AddScoped<MomAcceptanceService>();
builder.Services.AddScoped<IMomServiceEquipmentRepository, FreeSqlMomServiceEquipmentRepository>();
builder.Services.AddScoped<IMomServiceEquipmentLifecycleRepository, FreeSqlMomServiceEquipmentLifecycleRepository>();
builder.Services.AddScoped<MomServiceEquipmentService>();
builder.Services.AddScoped<IMomServiceWorkOrderRepository, FreeSqlMomServiceWorkOrderRepository>();
builder.Services.AddScoped<IMomServiceWorkOrderHistoryRepository, FreeSqlMomServiceWorkOrderHistoryRepository>();
builder.Services.AddScoped<MomServiceWorkOrderService>();
builder.Services.AddScoped<IMomServiceWorkOrderPartConsumptionRepository, FreeSqlMomServiceWorkOrderPartConsumptionRepository>();
builder.Services.AddScoped<MomServiceWorkOrderPartConsumptionService>();
builder.Services.AddScoped<IMomQualityReportRepository, FreeSqlMomQualityReportRepository>();
builder.Services.AddScoped<MomQualityReportService>();
builder.Services.AddScoped<MomQualityInspectionService>();
builder.Services.AddScoped<IMomQualityInspectionGate>(sp => sp.GetRequiredService<MomQualityInspectionService>());
builder.Services.AddScoped<IMomOperatorResolver, FreeSqlMomOperatorResolver>();
builder.Services.AddScoped<MomOperationExecutionService>();
builder.Services.AddScoped<IMomOperationCompletionGate>(sp => sp.GetRequiredService<MomOperationExecutionService>());
...
builder.Services.AddScoped<ISalesOrderShipmentService>(sp => sp.GetRequiredService<SalesOrderService>());
...
builder.Services.AddScoped<IWorkflowActionHandler, PmsProjectChangeWorkflowActionHandler>();
builder.Services.AddScoped<IWorkflowActionHandler, PmsProjectWorkItemWorkflowActionHandler>();
builder.Services.AddScoped<IWorkflowActionHandler, PmsWeeklyWorkLogSubmissionWorkflowActionHandler>();
...
builder.Services.AddScoped<IWorkflowBusinessApproverSource, PmsProjectChangeWorkflowApproverSource>();
